...
import static com.vehicle.cons.CommonConstant.LOGIN_TO_URL;
import static com.vehicle.cons.CommonConstant.USER_CONTEXT;
...
public class ForumFilter implements Filter {
	...
	private static final String[] INHERENT_ESCAPE_URIS = { "/index.jsp",
			...
			"/board/listTopicComments-", "/board/listTopic-", "/video-",
			"/voice-", "/library/test/success.htm",
