			...
			<div data-role="content" data-theme="a">
				<div>
					<ul data-role="listview" style="margin-bottom: 5px">
						<li data-icon="false">
							...
							<p style="margin-left: 9px; margin-top: -2px;">
								已有 ${app.download_num} 人安装
							</p>							
							<p class="ui-li-aside">
								${app.size}MB
							</p>
							<div style="background-color: darkorange; width: 80px; height: 22px; float: right; margin-top: -22px;">
								<p style="margin-left: 27px; margin-top: 2px;">
									<a
										href=FileDownServlet?appname=${app.name}&&apptype=${app.type}
					...
					<table>
						<tr>
							<c:forEach var="poster" items="${posters}">
								<td>
									<a href="#expand_${poster}" data-rel="popup"
										data-position-to="window" data-transition="fade"><img
											class="popphoto"
											src="/data/app/${app.type}/${app.name}/${poster}.png"
											alt="App image" height="250" style="margin-right: 8px;">
									</a>
								</td>
								<div data-role="popup" id="expand_${poster}"
									data-overlay-theme="a" data-theme="d" data-corners="false">
									<a href="#" data-rel="back"> <img class="popphoto"
											src="/data/app/${app.type}/${app.name}/${poster}.png"
											style="max-height: 512px;" alt="App image">
									</a>
								</div>
							</c:forEach>
						</tr>
				...
				<div>
					<div data-role="header" data-theme="a"
						style="margin-top: 10; height: 40;">
						<h4 style="text-align: left; margin-left: 7px;">
							描述
						</h4>
					</div>
					<div style="margin-top: 10; margin-left: 7px;">
						${app.long_des}
					</div>
				</div>
